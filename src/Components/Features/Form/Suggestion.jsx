    ...
    <>
     <form method="post" onSubmit={handleSubmit}>
      <table>
        ...
        <tr>
          <td><label htmlFor="Suggestion">Suggestion</label></td>
          <td><textarea name="Suggestion" id="Suggestion" onChange={handleInputChange} cols="30" value={details.Suggestion} rows="10"></textarea></td>
        </tr>
        <tr>
          <td></td>
