  ...
  return (
    <>   
        ...
        <div className="product-card-chip">
          <span className="product-name">Name: {book.book_name}</span>
          <span className="product-price">Price :&#8377;{book.price}</span>
        </div>
        <span className="product-author">Author: {book.author}</span>
