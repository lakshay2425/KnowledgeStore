            ...
            <div className="w-[90vw] m-auto px-6 md:px-12 flex flex-wrap justify-between">
                <div className="w-full md:w-1/3 ">
                    ...
                    <p className="mb-4 mr-6">
                        Knowledge Store is your go-to online library for renting and exploring a wide range of books.
                    </p>
                    <div>
                        <span className="block"><i className="fas fa-phone mr-2"></i> +91 9874569875</span>
                ...
                <div className="w-full md:w-1/3 ">
                    ...
                    <form action="#" method="post" className="flex flex-col space-y-4 border-none">
                        <input type="email" name="email" autoComplete="email" className="p-2 rounded bg-gray-700 border border-gray-600 placeholder-gray-400 text-white" placeholder="Your email address..." />
                        <textarea name="message" autoComplete="off" className="p-2 rounded bg-gray-700 border border-gray-600 placeholder-gray-400 text-white" placeholder="Your message..."></textarea>
